            ...
            <div class="row d-flex flex-column justify-content-start align-items-center">
                <div class="container-card-index p-0 row" style="width: 50%;">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-12 wrapper-profile-image">
                        <img class="image-profile-index m-5" src="{{ asset('public/assets/user-profile-image/' . $image_profile) }}"
                            alt="">
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 col-12 d-flex mt-2 flex-column align-items-center wrapper-content-index"
                        ...
                        <p class="content-index m-4 pt-3">
                            Halo pembaca yang budiman. Selamat datang di blog Jelajah Buku. Seperti namanya, blog ini berisi ruang informasi buku, perpustakaan, dan para penulis buku. Tapi tidak cuma itu, blog ini juga menceritakan ceritaku dalam menjelajahi  hidup. Layaknya buku akan selalu ada halaman baru setiap waktu. Mari menjelajah bersamaku.                        </p>
