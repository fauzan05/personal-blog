            ...
            <div class="col-lg-12 no-padding mb-5 position-relative" style="height: 100%">
                ...
                <div class="row no-padding d-flex flex-column justify-content-center align-items-center"
                    ...
                    <div class="col-lg-12 d-flex flex-column align-items-center">
                        <span class="title-menu mt-5"> <strong>{{ ucwords($current_menu) }}</strong></span>
                    </div>
                    <div class="col-lg-10 my-5">
                        <div class="row d-flex flex-row align-items-center justify-content-center">
                            @foreach ($categories as $key => $category)
                                <a class="col-3 m-2 d-flex card-category rounded flex-row justify-content-center align-items-center"
                                    href="{{ url($current_menu . '/' . strtolower($category)) }}"
                                    style="text-decoration: none; height: 50px;">
                                    <span class="title-category m-3">{{ $category }}</span>
                                </a>
                            @endforeach
                        </div>
                    </div>
            ...
            <div class="col-lg-12 my-5 d-flex flex-column align-items-center justify-content-start no-padding">
                <div class="row d-flex flex-row justify-content-center align-items-start" style="width: 100%; ">
                    @foreach ($posts as $key => $post)
                        <a class="col-lg-3 m-2 shadow-sm card-post" href="{{ url('') }}"
