                ...
                <div class="row about-wrapper">
                    <div class="col-lg-7 col-md-7 col-sm-12 col-12 d-flex flex-column align-items-center justify-content-center">
                        <p class="about-content">
                            Jelajah buku lahir dari kecintaan penulis membaca buku. Setelah membaca buku ternyata ada
                            yang menganjal.
                            Kenapa tidak dibagikan pengalaman membaca ini? Akhirnya lahirlah Jelajah Buku di muka bumi
                            ini. Lewat
                            jelajah buku ini, penulis juga bisa memotivasi diri. Untuk selalu meluangkan waktu untuk
                            buku, menjelajah ke
                            luar rumah dan menulisakan kembali untuk bahan pengingat diri.

                            Mungkin lewat tulisan sederhana di sini mampu menularkan efek kecintaan membaca buku. Bahwa
                            membaca buku itu
                            menyenangkan. Apalagi bersama orang tersayang. Setiap orang akan menemukan bukunya
                            sendiri-sendiri. Maka
                            mulai jatuh cintalah dengan buku. Kelak kalian akan menemukan jodohmu.

                            Lagi- lagi membaca buku bukan sekadar menjelajah buku saja. Tetapi kita belajar mejelajah
                            ruang, waktu dan
                            alur cerita dalam hidup yang terus berjalan. Mari menjelajah buku.
                        </p>
                    </div>
